...
def test_secondary_adapter_pipeline(tmp_path: Path) -> None:
    ...
    csv_path.write_text(
        ...
        "2021 00:00:10.000000,192.168.1.10,192.168.1.1,0,Normal,2,0\n"
        "2021 00:01:10.000000,192.168.1.10,192.168.1.1,0,Normal,2,0\n"
        "2021 00:00:10.000000,192.168.1.11,192.168.1.1,0,Normal,2,0\n"
        "2021 00:01:10.000000,192.168.1.11,192.168.1.1,0,Normal,2,0\n"
        "2021 00:02:10.000000,192.168.1.10,192.168.1.1,1,DDoS_UDP,0,0\n"
        "2021 00:00:11.000000,192.168.1.12,192.168.1.1,0,MITM,0,0\n",
        encoding="utf-8",
    )
    records = tuple(
        entry
