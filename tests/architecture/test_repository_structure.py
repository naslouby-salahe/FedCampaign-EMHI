...
REQUIRED_TEST_FILES = (
    ...
    "tests/integration/preprocessing/test_ton_iot_network_pipeline.py",
    "tests/integration/preprocessing/test_edge_iiotset_pipeline.py",
...
REQUIRED_TEST_DIRECTORIES = (
    ...
    "tests/unit/config",
    "tests/unit/datasets",
    "tests/unit/datasets/ton_iot_network",
    "tests/unit/datasets/edge_iiotset",
    "tests/unit/models",
